...
class ApperanceTab(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.fontEntry.grid(row=2, column=0)
        ...
        self.previewMain = tk.Label(self.previewPane, bg=self.mainColor.getColor(), text="PHOTOBOOTH", fg=self.fontColor, font=self.fontEntry.getFont())
        self.previewMain.grid(row=0, column=0, sticky="nsew")
        self.previewSecondary = tk.Label(self.previewPane, bg=self.secondaryColor.getColor(), text="PHOTOBOOTH", fg=self.fontColor, font=self.fontEntry.getFont())
    ...
    def updatePreviewPane(self, *args):
        self.previewMain.configure(bg=self.mainColor.getColor(), fg=self.fontColor, font=self.fontEntry.getFont())
        self.previewSecondary.configure(bg=self.secondaryColor.getColor(), fg=self.fontColor, font=self.fontEntry.getFont())
